...
<body>
  <nav class="navbar navbar-defaul navbar-fixed-top navbar-inverse">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#" style="padding: 1px;"><img class="img-responsive" alt="Brand" src="img/logotwo.png"  style="width: 118px;margin-top: -7px;margin-left: -10px;"></a>
        </div>
